...
public class MessageByMQ{  
     ...
     static{  
         ...
         MQEnvironment.hostname="192.168.1.20";          //MQ服务器的IP地址        
     ...
     public static int sendMessage(String message){  
         ...
         try{     
             //设置将要连接的队列属性  
             // Note. The MQC interface defines all the constants used by the WebSphere MQ <a href="http://lib.csdn.net/base/java" class='replace_word' title="Java 知识库" target='_blank' style='color:#df3434; font-weight:bold;'>Java </a>programming interface   
